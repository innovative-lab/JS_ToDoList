...
var _listTemplate = __webpack_require__(6);
...
function selectingDOMElements() {
    ...
    _this.backdrop_parent.innerHTML += (0, _modalTemplate2.default)();
...
function bindingListerner() {
    addEventListener(done_El, 'click', function (ev) {
        deleteConfirm(_this.seleted_El);
    });
    addEventListener(cancel_El, 'click', function (ev) {
        deleteCancel();
    });
...
function deleteConfirm(event) {
    _this.dataSet = _this.dataSet.filter(function (item) {
        if (event.target.parentElement.parentElement.id != item.id) {
            return true;
        }
    });
...
function render() {
    ...
    _this.dataSet.forEach(function (item) {
        _this.list_container.innerHTML += (0, _listTemplate2.default)(item);
    });
}
...
var listTemplate = function listTemplate(prop) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=app.3fd8c8bceb3edd8b3df0.js.map